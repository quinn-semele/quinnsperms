...
object Constants {
    const val GROUP = "dev.compasses.quinnsperms"
    const val MOD_ID = "quinnsperms"
    const val MOD_NAME = "Quinn's Perms"
    const val MOD_VERSION = "1.0.0"
    const val LICENSE = "CC0-1.0"
    const val DESCRIPTION = "A quick and simple mod to allow configuring Serene Seasons' snow accumulation per FTB Teams party."

    const val HOMEPAGE = "https://github.com/quinn-semele/quinnsperms"
    const val ISSUE_TRACKER = "https://github.com/quinn-semele/quinnsperms/issues"
    const val SOURCES_URL = "https://github.com/quinn-semele/quinnsperms"
    ...
    const val COMPARE_URL = "https://github.com/quinn-semele/quinnsperms/compare/"
